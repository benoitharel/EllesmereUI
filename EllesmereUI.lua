...
local ADDON_ROSTER = {
    ...
    { folder = "EllesmereUIInterruptTracker",  display = "Interrupt Tracker",    search_name = "EllesmereUI Interrupt Tracker"       },
}
...
function EllesmereUI:RegisterModule(folderName, config)
    ...
    local ALLOWED = {
        ...
        EllesmereUIInterruptTracker = true,
    }
